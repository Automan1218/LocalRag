...
public class LogUtils {
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("sg.edu.nus.p2.business");

    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("sg.edu.nus.p2.performance");
